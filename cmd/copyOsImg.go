...
var copyOsImgCmd = &cobra.Command{
	Use:     "copy-os-img",
	Aliases: []string{"copy-os-images", "cp-os-img", "copyosimg", "cposimg", "copyosimages"},
	Short:   "Copies os image files from given directory into the http container.",
	Long: `This command takes os images (rootfs.img, ) from the given directory,
and copies those files into the http container. For example:

	helpernodectl copy-os-img --dir=/path/to/install/dir
...
func copyOsImgToWebServer(dir string) {
